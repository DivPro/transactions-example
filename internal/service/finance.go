...
type Users interface {
	ListWithBalance(ctx context.Context) ([]entity.User, error)
}
...
func (f Finance) ListTransactions(ctx context.Context) ([]entity.Transaction, error) {
	return f.transactions.List(ctx)
}

func (f Finance) ListUsers(ctx context.Context) ([]entity.User, error) {
